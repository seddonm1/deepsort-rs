        ...
        match target_width.partial_cmp(&target_height) {
            Some(ord) => match ord {
                ...
                Ordering::Less => {
                    ...
                    let padding = (source_width - source_width / target_hw_ratio * source_hw_ratio)
                        / 2.0
                        * scale_y;
                    x -= padding;
                }
                Ordering::Equal => match source_width.partial_cmp(&source_height) {
                    Some(cmp) => match cmp {
                        Ordering::Less => {
                            ...
                            let padding = (source_height
                                - source_height / target_wh_ratio * source_wh_ratio)
                                / 2.0
                                * scale_x;
                            y -= padding;
                        }
                        ...
                        Ordering::Greater => {
                            ...
                            // subtract padding from the padded x dimension
                            let padding = (source_width
                                - source_width / target_hw_ratio * source_hw_ratio)
                                / 2.0
                                * scale_y;
                            x -= padding;
                        }
                ...
                Ordering::Greater => {
                    ...
                    // subtract padding from the padded y dimension
                    let padding =
                        (source_height - source_height / target_wh_ratio * source_wh_ratio) / 2.0
                            * scale_x;
                    y -= padding;
                }
            },
